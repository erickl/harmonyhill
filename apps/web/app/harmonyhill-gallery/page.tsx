...
const images = [
    ...
    { src: "/images/bdr-3-villa-1.jpeg",              width: 1440, height: 1080, alt: "bed room"                                                },
    ...
    { src: "/images/villa-1-bath-3-toilet.jpeg",      width: 1440, height: 1920, alt: "shower and toilet"                                       },
    ...
    { src: "/images/flowers-pool-deck.jpeg",          width: 480,  height: 360,  alt: "flowery pool deck"                                       },
    ...
    { src: "/images/bdr-2-villa-1.jpeg",              width: 1440, height: 1080, alt: "morning light in bedroom"                                },
    { src: "/images/water-rice-paddies.jpeg",         width: 668,  height: 1280, alt: "water filled rice paddies"                               },
    { src: "/images/villa-1-coffee-supplies.jpeg",    width: 1440, height: 1080, alt: "french press coffee"                                     },
    { src: "/images/floating-breakfast-2.jpeg",       width: 930,  height: 698,  alt: "floating breakfast"                                      },
    { src: "/images/villa-1-bath-2.jpeg",             width: 1440, height: 1080, alt: "bathroom"                                                },
    { src: "/images/villa-bdr-2.jpeg",                width: 960,  height: 1280, alt: "bedroom"                                                 },
    { src: "/images/infinity-pool-2.jpeg",            width: 960,  height: 1280, alt: "infinity pool"                                           },
